...
Met behulp van een moderne applicatie lossen wij de volgende problemen op:
- Dubbele boekingen
- Onduidelijkheid rondom beschikbaarheid
- Gebrek aan inzicht in schades en onderhoud
- Geen integratie van weersinformatie

## Doel van de applicatie
Het reserveringssysteem biedt de volgende functionaliteiten:
- Inlog functionaliteit voor leden en bestuur.
- Reserveren van boten op basis van niveau, beschikbaarheid en tijd.
...
- .NET MAUI.
- SQL lite.
- WeatherAPI.com (voor weersinformatie).
- Scrum werkwijze met sprints

## Planning en team
Het project bestaat uit de volgende fasen:
1. Analyse & ontwerp — 2 weken
