    ...
    public class BoatRepository : DatabaseConnection, IBoatRepository
    {
        ...
        public BoatRepository()
        {
            ...
            InsertMultipleWithTransaction(new List<string> {
               ...
               $@"INSERT OR IGNORE INTO boat (boat_id, name, type, level, status, seats_amount, SteeringwheelPosition) VALUES(4,'Vliegende Vis',{(int)BoatType.twox},{(int)BoatLevel.Beginner},{(int)BoatStatus.Fixing},3, true)",
               $@"INSERT OR IGNORE INTO boat (boat_id, name, type, level, status, seats_amount, SteeringwheelPosition) VALUES(5,'Gloeiende Kwal',{(int)BoatType.twox},{(int)BoatLevel.Beginner},{(int)BoatStatus.Broken},2, true)",
               $@"INSERT OR IGNORE INTO boat (boat_id, name, type, level, status, seats_amount, SteeringwheelPosition) VALUES(6,'Oreo Orca',{(int)BoatType.twox},{(int)BoatLevel.Beginner},{(int)BoatStatus.Broken},2, true)"
