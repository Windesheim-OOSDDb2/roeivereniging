...
namespace RoeiVereniging.ViewModels
{
    public partial class AddUserViewModel : BaseViewModel
    {
        ...
        public void AddUser()
        {
            ...
            User newUser = _userService.Set(new User(0, FirstName!, LastName!, Email!, PasswordHelper.HashPassword(Password!), SelectedRole, SelectedBoatLevel, DateOnly.FromDateTime(DateOfBirth), DateTime.Now));
